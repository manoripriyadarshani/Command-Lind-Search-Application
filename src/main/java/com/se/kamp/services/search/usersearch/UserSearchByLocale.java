...
/**
 * A class to handle specific logic for search by locale  from user search
 *
 * @author Manori Priyadarshani
 * @since 10/5/2019
 */
public class UserSearchByLocale extends UserSearch
{

  @Override
  protected List<User> getMatchingUsers(String value)
  {
    List<User> matchingUsers = dataStore.userByLocale.get(value);
