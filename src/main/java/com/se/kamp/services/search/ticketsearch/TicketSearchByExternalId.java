...
/**
 * A class to handle specific logic for search by ExternalID  from ticket search
 *
 * @author Manori Priyadarshani
 * @since 10/6/2019
 */
public final class TicketSearchByExternalId extends TicketSearch
{

  @Override
  protected List<Ticket> getMatchingTickets(String value)
  {
    List<Ticket> tickets = dataStore.ticketByExternalId.get(value);
